        ...
        <CardContent className="space-y-5">
          ...
          <div className="overflow-x-auto rounded-md border border-border">
            <Table><TableHeader><TableRow><TableHead>Message</TableHead><TableHead>Audience</TableHead><TableHead>Window</TableHead><TableHead>Status</TableHead><TableHead className="w-24" /></TableRow></TableHeader><TableBody>
              {announcements.length === 0 && <TableRow><TableCell colSpan={5} className="h-16 text-center text-sm text-muted-foreground">No announcements. Anything published here is shown to every user until it expires.</TableCell></TableRow>}
