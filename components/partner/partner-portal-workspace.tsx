...
export function PartnerPortalWorkspace({ role, partnerStatus }: { role: PartnerRole; partnerStatus: "draft" | "active" | "paused" | "offboarded" }) {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-6">
      ...
      <PartnerLeadPipeline partnerStatus={partnerStatus} />
      <Card>
