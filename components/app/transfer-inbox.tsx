...
type Item = { id: string; leadId: string; customer: string; age: string; state: string; productLine: string; partnerName: string; status: string; ownerName: string | null; waitSeconds: number; screeningOutcome: string; screeningWarning: string | null; duplicateWarning: boolean; queuedAt: string };
