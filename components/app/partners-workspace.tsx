...
export function PartnersWorkspace({ readOnly }: { readOnly: boolean }) {
  ...
  async function send(path: string, method: "POST" | "PATCH", body: Record<string, unknown>, success: string) {
