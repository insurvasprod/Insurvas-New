...
export const AGENT_MENU: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      item("Sell", { key: "sell.deal-flow", label: "Daily deal flow", path: "/app/deal-flow", icon: "clipboard-list", required_feature: "daily_deal_flow", required_roles: ["owner", "producer"] }),
    ],
  },
  {
    id: "retention",
