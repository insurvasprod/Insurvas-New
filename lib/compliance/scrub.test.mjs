...
const { getUsPhone10Digits, maskDialPhone, normalizeDialPhone, parseDncScrubDecision } = await import("./scrub.ts");
...
test("canonicalizes US +1 forms using the last ten digits", () => {
  assert.equal(getUsPhone10Digits("+1 (555) 123-4567"), "5551234567");
  assert.equal(getUsPhone10Digits("15551234567"), "5551234567");
  assert.throws(() => getUsPhone10Digits("555123"), /valid US phone/);
});
