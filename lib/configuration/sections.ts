...
export const CONFIGURATION_SECTIONS = [
  ...
  },
  {
    slug: "carriers",
    label: "Carriers",
    description: "The carrier library agents use for their appointments and commissions.",
    owner: "LA-0.4",
    icon: "carriers",
    keywords: "carrier insurance company appointments contract",
  },
  {
    slug: "templates",
    label: "Templates",
...
const SECTION_ACCESS: Record<ConfigurationSectionSlug, readonly AdminRole[]> = {
  ...
  carriers: ["super_admin", "platform_config"],
...
const AUDIT_SECTION: Record<ConfigurationAuditAction, ConfigurationSectionSlug> = {
  ...
  "carrier.created": "carriers",
  "carrier.updated": "carriers",
  "carrier.archived": "carriers",
  "carrier.restored": "carriers",
