-- LA-1.10: apply every inbox filter before the 500-row cap. Without this replacement,
-- a filtered request could inspect only the oldest 500 mixed rows and miss matching work.
