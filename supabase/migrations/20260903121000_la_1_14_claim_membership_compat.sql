-- LA-1.14 compatibility: tenant_users membership is active when the linked user is active.
...
begin
  ...
  insert into public.verification_sessions(tenant_id,work_item_id,lead_id,user_id,agent_role) values(p_tenant_id,item.id,item.lead_id,p_user_id,resolved_role)
